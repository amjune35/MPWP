---
title: "V3 Gen Perm All 03_23_25"
author: "Alicia June"
date: "2025-03-24"
...
This document is V3 of conducting PERMANOVA .The distance matrix is calculated using proportional abundance and the DCA scores were calculated (3-15-2025). The data is being used is genera ONLY data (03-13-2025). V3 uses 5 samples for each member. It excludes the following samples: 
...
write_csv(perm_dist_df, "gen_V3_dist_all.csv")
perm_dist_df
```
