---
title: "Species PERMANOVA (all members)"
author: "Alicia June"
...
This document contains code to conduct PERMANOVA comparing the Sunken Meadow, Rushmere, and Moore House members of the Yorktown Formation. The distance matrix is calculated using species ONLY proportional abundance data. 5 samples were used for each member.
...
write_csv(perm_dist_df, "sp_dist_all.csv")
perm_dist_df
```
