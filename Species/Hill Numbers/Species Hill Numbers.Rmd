...
write_csv( SM_samples_observed, "SM_sp_Obs.csv")
SM_samples_observed
```
...
write_csv(SM_rare_data, "SM_sp_rare.csv")
head(SM_rare_data)
```
...
write_csv( RM_samples_observed, "RM_sp_Obs.csv")
RM_samples_observed
```
...
write_csv(RM_rare_data, "RM_sp_rare.csv")
head(RM_rare_data)
...
write_csv( MH_samples_observed, "MH_sp_Obs.csv")
...
write_csv(MH_rare_data, "MH_sp_rare.csv")
head(MH_rare_data)
```
